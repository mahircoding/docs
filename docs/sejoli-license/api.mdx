...
`dinonaktifkan` → Kunci lisensi dicabut
...
Untuk mendapatkan informasi versi kunci lisensi:
...
- Properti section adalah array berseri yang mencakup deskripsi produk lengkap dan log perubahan. Jika menggunakan penguraian ReadMe.txt untuk plugin WordPress, itu juga akan menyertakan informasi tambahan yang diberikan melalui file readme.

**Bagaimana cara mencegah akses ke perangkat lunak, plugin, atau tema saya jika lisensinya sudah habis masa berlakunya atau dinonaktifkan?**
